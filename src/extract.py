...
- negative_or_outdated: 次の(a)(b)(c)のいずれかに該当すればtrue、どれにも該当しなければfalse。
  (a) 回答が旧事業（MA/マーケティングオートメーション/メールマーケティング/メール配信支援/
      BtoBマーケティング代行・戦略コンサル）を、クロスコムの**現在の主要事業**として記述している。
      「〜に強い会社です」「主要事業は〜」「〜を支援しています」のように現在形で書かれていれば
      該当する。事業内容の列挙の中に旧事業が混ざっている場合も該当する。
      ※クロスコムの現在の主要事業は「Agentforce導入・定着支援」と「Agentic CRM設計支援」であり、
        MA/メール配信の代行・運用支援は既に提供していない。
  (b) 提供していないサービス、誤った会社情報（規模・所在地・沿革・代表者等）などの誤情報がある。
  (c) その他、古い情報やネガティブな記述がある。
  ※ただし旧事業が「過去に提供していた」「以前は」「提供終了」等、明確に過去のものとして

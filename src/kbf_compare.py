...
自社の文脈か競合の文脈かは、KBF語の**直前にある社名**で決める(2026-09-01 採用)。
比較回答は「◯◯社は…」と社名で節が始まる構造なので、直前の社名がその語の
持ち主になる。単純な近さで測ると、直後に別の社名が来ただけでそちらに取られる。

> **2026-12 に手読みと照合すること(2026-09-01 の判断)。**
> この切り分けは構造の仮定に乗っている。見出しが無い回答や、
> 1文の中で両社を比べる書き方が増えると外れる。
> 3回分(2026-09/10/11)の lk_kbf_compare を回答本文と突き合わせ、
> 判定が合っているかを確かめる。ずれていれば方式を変える。
"""
